...
psrp %>% 
  ...
  ungroup() %>% 
  arrange(desc(w_use_af)) 
```


## SON

Missing data for VOMWD and Sonoma City. Would explain perhaps the higher calculated commercial/residential water use here.
...
Missing data for Penngrove. Would explain perhaps the higher calculated commercial/residential water use here.
